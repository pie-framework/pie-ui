...
let TopAppBar = class TopAppBar extends BaseElement {
    ...
    createAdapter() {
        return Object.assign({}, super.createAdapter(), { setStyle: (property, value) => this.mdcRoot.style.setProperty(property, value), getTopAppBarHeight: () => this.mdcRoot.clientHeight, 
            ...
            }, registerScrollHandler: (handler) => this.scrollTarget.addEventListener('scroll', handler), deregisterScrollHandler: (handler) => this.scrollTarget.removeEventListener('scroll', handler), registerResizeHandler: (handler) => window.addEventListener('resize', handler), deregisterResizeHandler: (handler) => window.removeEventListener('resize', handler), getViewportScrollY: () => this.scrollTarget[this.scrollTarget === window ? 'pageYOffset' : 'scrollTop'], getTotalActionItems: () => this._actionItemsSlot.assignedNodes({ flatten: true }).length });
    }
...
], TopAppBar.prototype, "mdcRoot", void 0);
__decorate([
    query('[name="navigationIcon"]')
], TopAppBar.prototype, "_navIconSlot", void 0);
__decorate([
    query('[name="actionItems"]')
], TopAppBar.prototype, "_actionItemsSlot", void 0);
__decorate([
    property({ reflect: true })
], TopAppBar.prototype, "type", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], TopAppBar.prototype, "dense", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], TopAppBar.prototype, "extraRow", void 0);
